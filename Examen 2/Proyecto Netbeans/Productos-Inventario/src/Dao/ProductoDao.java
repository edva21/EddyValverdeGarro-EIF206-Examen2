...
public class ProductoDao extends DAO implements CRUD<Producto> {
   private static ProductoDao INSTANCE;    
    ...
    private static final String BUSCARproductoByNombre = "{?=call readbynameproducto(?)}"; 
    private static final String BUSCARproductoByTipo = "{?=call readbytipoproducto(?)}"; 
...
//            throw new GlobalException("No se ha localizado el driver");
  ...
  //          throw new NoDataException("La base de datos no se encuentra disponible");
         ...
         try {
            ...
            pstmt.setString(2, u.getNombreProducto());
            pstmt.setBoolean(3, u.getImportadoProducto());
            pstmt.setInt(4, u.getPrecioProducto());
   ...
   //         throw new NoDataException("La base de datos no se encuentra disponible");
        ...
        try {            
            ...
            while (rs.next()) {
                ...
                a.setImportadoProducto(rs.getBoolean("importado_producto"));
   ...
   //         throw new NoDataException("La base de datos no se encuentra disponible");
        ...
        try {            
            ...
            while (rs.next()) {
                ...
                a.setImportadoProducto(rs.getBoolean("importado_producto"));                
                a.setPrecioProducto(rs.getInt("precio_producto"));
                a.setTipoProducto(rs.getString("codigo_tipo"));
                coleccion.add(a);
            }
        } catch (SQLException e) {
          e.printStackTrace();
    ...
    public ObservableList<Producto> readByNombre(Object o) {
        try {
            conectar();
        } catch (ClassNotFoundException e) {
   //         throw new GlobalException("No se ha localizado el driver");
   ...
   //         throw new NoDataException("La base de datos no se encuentra disponible");
        ...
        CallableStatement pstmt=null;  
        try {            
            pstmt = conexion.prepareCall(BUSCARproductoByNombre);            
            pstmt.registerOutParameter(1, OracleTypes.CURSOR);            
            pstmt.setString(2,o.toString());            
            pstmt.execute();
            rs = (ResultSet)pstmt.getObject(1); 
    ...
    public ObservableList<Producto> readbyTipo(Object o) {
        try {
            conectar();
        } catch (ClassNotFoundException e) {
   //         throw new GlobalException("No se ha localizado el driver");
   ...
   //         throw new NoDataException("La base de datos no se encuentra disponible");
        ...
        CallableStatement pstmt=null;  
        try {            
            pstmt = conexion.prepareCall(BUSCARproductoByTipo);            
            pstmt.registerOutParameter(1, OracleTypes.CURSOR);            
            pstmt.setString(2,o.toString());            
            pstmt.execute();
            rs = (ResultSet)pstmt.getObject(1); 
